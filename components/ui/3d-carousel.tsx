...
// 🔹 Use correct layout effect for client/server rendering
      ...
      <AnimatePresence mode="sync">
        {activeImg && (
          <motion.div
            ...
            onClick={handleClose}
            className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-5 md:p-20 rounded-3xl"
