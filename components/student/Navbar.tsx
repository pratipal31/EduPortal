...
export default function StudentNavbar({
  ...
  return (
    <>
      ...
      <div
        className={`${isCollapsed ? "w-20" : "w-64"} min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-cyan-900 text-white transition-all duration-300 ease-in-out flex flex-col fixed left-0 top-0 shadow-2xl z-50 transform ${
          mobileOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0`}
      >
        {/* Logo / Header Section with Toggle */}
        ...
        {/* Logout */}
        <div className="border-t border-blue-700/50 px-3 py-4">
          <button
